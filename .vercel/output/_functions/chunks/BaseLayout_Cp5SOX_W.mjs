import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, l as defineScriptVars, d as renderComponent, n as renderHead, g as renderSlot } from './astro/server_BdqoPpAV.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                          */
import { $ as $$Image } from './_astro_assets_DNZp5tZd.mjs';
import { S as SITE_TITLE, a as SITE_DESCRIPTION } from './config_B6QMqooP.mjs';
...
}, "C:/Users/Lenovo/Desktop/Portofolio/src/components/BaseHead.astro", void 0);
...
}, "C:/Users/Lenovo/Desktop/Portofolio/src/components/Header.astro", void 0);
...
}, "C:/Users/Lenovo/Desktop/Portofolio/src/components/Footer.astro", void 0);
...
}, "C:/Users/Lenovo/Desktop/Portofolio/src/components/SideBarFooter.astro", void 0);
...
const $$SideBarMenu = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<ul class="menu grow shrink menu-md overflow-y-auto"> <li><a class="py-3 text-base" id="home" href="/">Home</a></li> <li><a class="py-3 text-base" id="projects" href="/projects">Projects</a></li> <!-- <li><a class="py-3 text-base" id="services" href="/services">Services</a></li> --> <!-- <li><a class="py-3 text-base" id="store" href="/store">Store</a></li> --> <!-- <li><a class="py-3 text-base" id="blog" href="/blog/">Blog</a></li> --> <li><a class="py-3 text-base" id="cv" href="/cv">CV</a></li> <li> <a class="py-3 text-base" href="mailto:rafiframadhan190@gmail.com" target="_blank" referrerpolicy="no-referrer-when-downgrade">Contact</a> </li> </ul> <script>(function(){', "\nconst activeItemElem = document.getElementById(sideBarActiveItemID);\nactiveItemElem && activeItemElem.classList.add(activeClass);\n})();<\/script>"])), maybeRenderHead(), defineScriptVars({ sideBarActiveItemID, activeClass }));
}, "C:/Users/Lenovo/Desktop/Portofolio/src/components/SideBarMenu.astro", void 0);
...
}, "C:/Users/Lenovo/Desktop/Portofolio/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "C:/Users/Lenovo/Desktop/Portofolio/src/layouts/BaseLayout.astro", void 0);
